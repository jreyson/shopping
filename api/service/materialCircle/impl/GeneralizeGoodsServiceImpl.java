package com.shopping.api.service.materialCircle.impl;
...
@Service("generalizeGoodsServiceImpl")
@Transactional
public class GeneralizeGoodsServiceImpl<T> implements IMCFunctionService<T> {
	@Resource(name = "generalizeGoodsDao")
